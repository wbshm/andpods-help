...
* Android 手机蓝牙的版本在5.0以上。（因为耳机状态的获取属于低功耗蓝牙，低于5.0的手机不支持低功耗蓝牙）
...
3. 目前依然存在部分**蓝牙5.0**以下机型不能显示AirPods2、AirPods Pro、PowerBeatsPro、BeatsSoloPro、PowerBeats4电量。（可以通过 [中关村在线](https://m.zol.com.cn/mobile/) 查看手机参数）
4. **充电仓的电量**需要一只耳机放在盒子里并保持开盖状态才能看。
